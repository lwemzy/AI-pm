import { AlertCircleIcon, BarChartIcon, MapIcon, UserIcon, TrendingUpIcon, DollarSignIcon, ScaleIcon, ClipboardCheckIcon } from 'lucide-react';
...
export function ReportsList({
    ...
    const reports = [{
        ...
        id: 'pricing',
        name: 'Pricing Report',
        description: 'Drug pricing transparency and spread analysis',
        icon: <DollarSignIcon size={20} />
    }, {
        id: 'pbm-comparison',
        name: 'PBM Comparison Report',
        description: 'Cross-PBM cost and performance comparison',
        icon: <ScaleIcon size={20} />
    }, {
        id: 'audit',
        name: 'Audit Report',
        description: 'Contract compliance and overcharge findings',
